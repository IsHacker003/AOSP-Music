...
package com.ishacker.android.music.activities;
...
import com.ishacker.android.music.CreatePlaylist;
import com.ishacker.android.music.DeleteItems;
import com.ishacker.android.music.IMediaPlaybackService;
import com.ishacker.android.music.MediaPlaybackService;
import com.ishacker.android.music.R;
import com.ishacker.android.music.RepeatingImageButton;
...
public class MediaPlaybackActivity extends Activity implements MusicUtils.Defs,
    ...
    public void onCreate(Bundle icicle) {
        ...
        // Find the root view
        mActivity = mPauseButton.getRootView();
    ...
    public void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            View root = mProgress.getRootView();
            View v = findViewById(R.id.playerBar);

            int display_mode = getResources().getConfiguration().orientation;
            if (display_mode == Configuration.ORIENTATION_LANDSCAPE) {
                root.setPadding(0, (int) (metrics.density * 24), (int) (metrics.density * 56), 0);
                v.setPadding(0, 0, 0, 0);
            } else {
                root.setPadding(0, (int) (metrics.density * 24), 0, 0);
                v.setPadding(0, 0, 0, (int) (metrics.density * 60));
            }
        }
...
*/
                    ...
                    Palette.from((Bitmap) msg.obj).generate(new Palette.PaletteAsyncListener() {
                        ...
                        public void onGenerated(Palette p) {
                            TransitionDrawable transition = new TransitionDrawable(new Drawable[]{
                                    mActivity.getBackground().getCurrent(),
                                    new ColorDrawable(p.getVibrantColor(p.getDominantColor(mActivity.getSolidColor())))
                            });

                            mActivity.setBackgroundDrawable(transition);
                            transition.startTransition(250);
                        }
                    });
                } catch (IllegalArgumentException exception) {
                    // Catch expected IllegalArgumentExceptions.
                    Log.e(this.getLocalClassName(), exception.getMessage());
                    Log.e(this.getLocalClassName(), exception.getStackTrace().toString());
    ...
    private final Handler mHandler = new NowPlayingHandler(this);
