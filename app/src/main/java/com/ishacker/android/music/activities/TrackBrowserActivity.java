...
import com.ishacker.android.music.utils.MusicAlphabetIndexer;
import com.ishacker.android.music.R;
import com.ishacker.android.music.TouchInterceptor;
    ...
    static class TrackListAdapter extends SimpleCursorAdapter implements SectionIndexer {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            if ((mIsNowPlaying && cursor.getPosition() == id) ||
                ...
                iv.setImageResource(R.drawable.ic_action_av_play_circle_fill);
        ...
        public void changeCursor(Cursor cursor) {
            ...
            if (cursor != null && cursor != mActivity.mTrackCursor && !cursor.isClosed()) {
